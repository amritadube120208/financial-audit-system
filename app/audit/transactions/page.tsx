...
export default function TransactionsEmptyPage() {
  return (
    <div className="flex-1 flex items-center justify-center p-6 sm:p-12">
      <div className="max-w-md w-full text-center p-8 rounded-2xl border border-border bg-card shadow-sm">
        ...
        <h2 className="text-lg font-bold text-foreground">No Transactions Selected</h2>
        <p className="text-xs sm:text-sm text-muted-foreground mt-2 leading-relaxed">
          Transactions are strictly scoped to an active audit run. Please select or start an audit to inspect its ledger transactions.
        </p>
        <div className="mt-6">
          <Link
            href="/"
